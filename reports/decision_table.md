...
| Particle Filter feature generator | Candidate Ridge features | Conditional | Target-free implementation complete; first 100-real-well validation required | None | Hidden TVT_input or fold/cache mixing if boundary keys are wrong | Per-well/fold cache; visible prefix only; NumPy CPU path | Unknown | **DIAGNOSTIC ONLY — NOT PROMOTED** |
| Beam Search feature generator | Candidate Ridge features | Conditional | Target-free implementation complete; first 100-real-well validation required | None | Same as PF | Per-well/fold cache; visible prefix only; bounded beam | Unknown | **DIAGNOSTIC ONLY — NOT PROMOTED** |
